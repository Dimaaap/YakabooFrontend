...
const BonusesLeftSection = () => {
    ...
    return(
        <div className="bonuses__section left-section info-sidebar">
          <div className="info-sidebar-block">
            <div className="settings-header__profile-info info-sidebar-info">
              <div className="settings-header__profile-left info-sidebar-header">
                <button className="settings-header__user-btn info-sidebar-user-btn">
                  <Image  src="/icons/user-white.svg" className="settings-header__user-icon info-sidebar-user-icon" alt="" 
                  width="18" height="18" />
                </button>
                <div className="settings-header__profile-main-info info-sidebar-main-info">
                  <div className="settings-header__profile-user info-sidebar-user">
                  </div>
                  <p className="settings-header__username info-sidebar-username">
                    { getUserFullName() }
                  </p>
                  <span className="settings-header__user_phone info-sidebar-user-phone">
                    +{ CookiesWorker.get("phone_number") }
                  </span>
                </div>
              </div>
              <Link href="/my-account" className="settings-header__edit-icon info-sidebar-edit-icon">
                <Image src="/icons/edit.svg" alt="" width="15" height="15" />
              </Link>
            </div>
            <div className="info-sidebar-wrapper">
              <div className="settings-header__tiles-block info-sidebar-tiles-block">
          ...
          <div className="menu__body settings-body info-sidebar-body">
            <ul className="settings-menu info-sidebar-menu">
              { sidebarLinks.map((item, index) => (
                <li className={`settings-point info-sidebar-point ${getCurrentLink(item.link) === accountSection ? "active-point" : ""}`} key={ index }>
          ...
          <div className="menu__body settings-footer-second info-sidebar-footer">
