  ...
  return (
    <div className="container-info__delivery-terms delivery-terms">
      <div className="delivery-terms__row">
        ...
        <div className="delivery-terms__cell">
          <p className="delivery-terms__price">30 грн</p>
      ...
      <div className="delivery-terms__row">
        ...
        <div className="delivery-terms__cell">
          <p className="delivery-terms__price">60-95 грн</p>
          <Image src="/icons/chevron-down.svg" alt="" width="16" height="16" />
        </div>
      </div>
      ...
      <div className="delivery-terms__row">
        ...
        <div className="delivery-terms__cell">
          <p className="delivery-terms__price">50 грн</p>
          <Image src="/icons/chevron-down.svg" alt="" width="16" height="16" />
        </div>
      </div>
      ...
      <div className="delivery-terms__row">
        ...
        <div className="delivery-terms__cell">
          <p className="delivery-terms__price">39-75 грн</p>
          <Image src="/icons/chevron-down.svg" alt="" width="16" height="16" />
        </div>
      </div>
