const Endpoints = {
  ...
  CHANGE_PASSWORD_WITH_EMAIL:
    'http://localhost:8003/auth/user/change-password-with-email',
  ...
  ALL_BOARD_GAME_PLAYERS_COUNT:
    'http://localhost:8003/game-ages/players-count/all',
  ALL_CONTACTS: 'http://localhost:8003/contacts/all',
  ALL_COUNTRIES: 'http://localhost:8003/countries/all',
};
